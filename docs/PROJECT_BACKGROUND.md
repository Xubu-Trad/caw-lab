# Preserved project background

This is the previous README, preserved for the mission, community acknowledgements and historical policies. Invitation and authority statements below have not been reverified as current. Use the [current README](../README.md) and linked status pages for research progress.
