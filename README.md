...
- `layers/R1-010_poem_coords/`
- `layers/R1-020_book_cipher/`
- `layers/R1-030_cid_audio/`
- `layers/R1-040_deepsound/`
- `layers/R1-050_manifesto_rebuild/`
- `layers/R2-000_anchor/`
- `layers/R2-010_pastebin_recovery/`
<!-- RIDDLE_PROGRESS_END -->
